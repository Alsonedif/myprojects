...
<html lang="en">
  ...
  <body>
    ...
    <div class="container‬">
        ...
        <input type="search" style="width:300px;" value='<?php echo $_GET['w']; ?>' name="w"><a onclick="$(this).closest('form').submit();" id="search" href="#" style=" padding: 8px;"><img src="imgs/search.png" style="width:40px; background-color:darkgrey;border-radius: 10px;"></a>
        </form>
    ...
    <div class="product-container">
      ...
      if($_SERVER['REQUEST_METHOD'] == 'GET' && isset($_GET['w'])){
      $sql = "select * from product where P_name LIKE '%".$_GET['w']."%' LIMIT ".$offset.",24;";
      ...
      <div class="nav-down">
          <?php
          $sql = "select * from product where P_name LIKE '%".$_GET['w']."%';";
          $p = intval($_GET['page']);
            $result = mysqli_query($conn,$sql);
            ...
            while($counter != $count){
              ...
              if($value == $p){
              echo "<a style='color:red' href='search.php?page=".$value."&w=".$_GET['w']."'>".$value."</a>";
              }else {
                echo "<a href='search.php?page=".$value."&w=".$_GET['w']."'>".$value."</a>";
              }
