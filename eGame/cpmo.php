    ...
    <title>CP ~ Main Menu</title>
     <script>
         $(document).ready(function(){
             var i=0;
            while(i==0){
        $.post('reqfun/tablequeares.php',{type:"orders",offset:"0",dcount:"10"},function(data){
            $('table').html(data); 
        });
          i++;   
         }});
    ...
    <a class="dropdown-item" href="cpmcu.php" style="color:black;">Manage Products sorted under catagroies</a>
      ...
      <div id="profile">
          ...
          <a style="color:black;" class="dropdown-item" href="#">Logout</a>
               ...
               <div class="middle-t"> 
                <a class="img_buttn_u" id="o_ref" href="#"><img src="imgs/if_refresh27_216529.png" width="20px" height="20px" class="imginside"></a><a href="#" class="img_buttn_u" id="ref_left_o"><img src="imgs/left.png" width="30px" height="30px" class="imginside" ></a><a href="#" id="ref_right_o" class="img_buttn_u"><img src="imgs/right.png" width="30px" height="30px" class="imginside"></a>
        <table>
